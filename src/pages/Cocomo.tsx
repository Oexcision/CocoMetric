...
import { Box, Container, Text, FormControl, Input, Button, FormLabel, Select, VStack, Stack, Accordion } from "@chakra-ui/react";
...
const Cocomo = () => {
  const [formData, setFormData] = useState<CocomoForm>({ mode: '', kdlc: 0, cpm: 0, costDrivers: [] });
